...
public abstract class AbstractSQLiteHelper extends SQLiteOpenHelper {
     ...
     * @return float 类型数据
     */
    protected final String decimal(int p, int s) {
        return " decimal(" + p + "," + s + ")";
    }
    ...
    protected Map<String, String> newTableColumns() {
        ...
        columns.put(BaseColumns._ID, primary());
        columns.put(BaseColumns._ENABLE, integer(1));
        columns.put(BaseColumns._ROW_LAST_UPDATED_TIME, integer(0));
        return columns;
    }
